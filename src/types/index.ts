...
export interface ToolContext { workspaceRoot: string; permissions: PermissionManager; currentState: AgentState; signal?: AbortSignal; }
...
export class PermissionError extends AgentError { constructor(message: string, details?: unknown) { super(message, 'PERMISSION_ERROR', details); this.name = 'PERMISSION_ERROR'; } }
export class WorkspaceError extends AgentError { constructor(message: string, details?: unknown) { super(message, 'WORKSPACE_ERROR', details); this.name = 'WORKSPACE_ERROR'; } }
export class ValidationError extends AgentError { constructor(message: string, details?: unknown) { super(message, 'VALIDATION_ERROR', details); this.name = 'VALIDATION_ERROR'; } }
