"use strict";
/**
 * DataAggregation - Production-ready implementation
...
exports.DataAggregation = void 0;
const events_1 = require("events");
const crypto = __importStar(require("crypto"));
class DataAggregation extends events_1.EventEmitter {
    config;
    requests = new Map();
    responses = new Map();
    metrics;
    ...
    log(message) {
        if (this.config.debug) {
            console.log(`[DataAggregation] ${message}`);
        }
...
exports.default = DataAggregation;
