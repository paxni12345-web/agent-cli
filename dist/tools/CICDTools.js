...
exports.PipelineGenerator = exports.ArtifactTool = exports.BuildTool = exports.RollbackTool = exports.DeploymentTool = exports.CICDPipelineTool = void 0;
const EventBus_1 = require("../core/EventBus");
/**
 * CI/CD Pipeline Tool
 */
exports.CICDPipelineTool = {
    name: 'cicd_pipeline',
...
exports.DeploymentTool = {
    ...
    execute: async (input) => {
        try {
            ...
            EventBus_1.eventBus.emitSync('deployment.completed', { environment: input.environment, service: input.service, version: input.version }, 'DeploymentTool');
            return { success: true, output };
        }
        catch (error) {
            return {
