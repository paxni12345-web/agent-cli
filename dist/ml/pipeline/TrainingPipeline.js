"use strict";
/**
 * TrainingPipeline - Production-ready implementation
...
class TrainingPipeline extends events_1.EventEmitter {
    config;
    requests = new Map();
    responses = new Map();
    metrics;
    ...
    log(message) {
        if (this.config.debug) {
            console.log(`[TrainingPipeline] ${message}`);
        }
...
exports.default = TrainingPipeline;
