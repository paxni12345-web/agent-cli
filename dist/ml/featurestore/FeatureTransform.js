"use strict";
/**
 * FeatureTransform - Production-ready implementation
...
exports.FeatureTransform = void 0;
const events_1 = require("events");
const crypto = __importStar(require("crypto"));
class FeatureTransform extends events_1.EventEmitter {
    config;
    requests = new Map();
    responses = new Map();
    metrics;
    ...
    log(message) {
        if (this.config.debug) {
            console.log(`[FeatureTransform] ${message}`);
        }
...
exports.FeatureTransform = FeatureTransform;
exports.default = FeatureTransform;
