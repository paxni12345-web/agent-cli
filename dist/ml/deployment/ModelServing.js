"use strict";
/**
 * ModelServing - Production-ready implementation
...
class ModelServing extends events_1.EventEmitter {
    config;
    requests = new Map();
    responses = new Map();
    metrics;
    ...
    log(message) {
        if (this.config.debug) {
            console.log(`[ModelServing] ${message}`);
        }
